...
CREATE TABLE Persona (idpersona int(10) NOT NULL AUTO_INCREMENT, nombre varchar(50) NOT NULL, apellidopaterno varchar(50) NOT NULL, apellidomaterno varchar(50) NOT NULL, curp varchar(18) NOT NULL, rfc varchar(13), fechanacimiento date NOT NULL, estadocivil varchar(1), PRIMARY KEY (idpersona));
CREATE TABLE Servicios (idservicio int(10) NOT NULL AUTO_INCREMENT, iddepartamento int(10) NOT NULL, idInstitucionfinanciera int(10) NOT NULL, nombreplan varchar(300) NOT NULL, descripcion varchar(300), PRIMARY KEY (idservicio));
...
CREATE TABLE promotor (idpromotor int(10) NOT NULL, PRIMARY KEY (idpromotor));
CREATE TABLE asesor (idasesor int(10) NOT NULL, tipolicencia int(10), PRIMARY KEY (idasesor));
CREATE TABLE asesor_cliente (idasesor int(10) NOT NULL, idcliente int(10) NOT NULL, idcliente_prospecto int(10) NOT NULL, idorigen int(10) NOT NULL, idestatus int(10) NOT NULL, personarecomendo int(10) NOT NULL, fechaactualizacion date NOT NULL, ocupacion varchar(150), dependientes varchar(150), ingresos float, asesoridpersona int(10) NOT NULL, PRIMARY KEY (idasesor, idcliente, asesoridpersona));
CREATE TABLE admon (rolesidrole2 int(10) NOT NULL);
CREATE TABLE promotor_asesor (idasesor int(10) NOT NULL, idpromotor int(10) NOT NULL, PRIMARY KEY (idasesor, idpromotor));
...
CREATE TABLE creditos (idcredito int(10) NOT NULL AUTO_INCREMENT, estatuscredito int(10) NOT NULL, idasesor int(10) NOT NULL, idcliente int(10), asesor_clienteasesoridpersona int(10), PRIMARY KEY (idcredito));
...
CREATE TABLE planes_concretados (idplan int(10) NOT NULL AUTO_INCREMENT, idasesor int(10) NOT NULL, idcliente int(10) NOT NULL, idservicio int(10) NOT NULL, fechacontratacion time NOT NULL, numeropoliza varchar(10) NOT NULL, primanetaanual float NOT NULL, plazoanos int(10) NOT NULL, valorplan float NOT NULL, observaciones varchar(300), asesor_clienteasesoridpersona int(10), PRIMARY KEY (idplan));
...
CREATE TABLE departamento (iddepartamento int(10) NOT NULL, idInstitucionfinanciera int(10) NOT NULL, nombre varchar(100) NOT NULL, ubicacion varchar(50), telefono varchar(15) NOT NULL, extension varchar(5), PRIMARY KEY (iddepartamento, idInstitucionfinanciera));
CREATE TABLE sesion1 (idsesion int(10) NOT NULL AUTO_INCREMENT, idasesor int(10) NOT NULL, idcliente int(10) NOT NULL, videopresentacion varchar(100), cartaconfidencialidad varchar(100), libertadfinancieraidlf int(10) NOT NULL, capitalizacionidcapitalizacion int(10) NOT NULL, blindajefinancieroidbl int(10) NOT NULL, asesor_clienteasesoridpersona int(10), PRIMARY KEY (idsesion));
CREATE TABLE libertadfinanciera (idlf int(10) NOT NULL AUTO_INCREMENT, edad int(10), montoobjetivo int(10), anos int(10), ahorro float, PRIMARY KEY (idlf));
CREATE TABLE capitalizacion (idcapitalizacion int(10) NOT NULL AUTO_INCREMENT, `Column` int(10), PRIMARY KEY (idcapitalizacion));
CREATE TABLE blindajefinanciero (idbl int(10) NOT NULL AUTO_INCREMENT, `Column` int(10), PRIMARY KEY (idbl));
CREATE TABLE estatus (idestatus int(10) NOT NULL AUTO_INCREMENT, nombre varchar(50) NOT NULL, descripcion varchar(200), PRIMARY KEY (idestatus));
CREATE TABLE origenrecomendacion (idorigen int(10) NOT NULL AUTO_INCREMENT, nombre varchar(50) NOT NULL, descripcion varchar(200), PRIMARY KEY (idorigen));
CREATE TABLE reporteactividad (idreporte int(10) NOT NULL AUTO_INCREMENT, idasesor int(10) NOT NULL, fechareporte date NOT NULL, recomendadosobtenidos int(10) NOT NULL, recomendadoscontactados int(10) NOT NULL, llamadasrealizadas int(10) NOT NULL, citasobtenidas int(10) NOT NULL, citastotales int(10) NOT NULL, citasnuevas int(10) NOT NULL, entrevistasinicialesplaneadas int(10) NOT NULL, entrevistasinicialesrealizadas int(10) NOT NULL, entrevistascierreplaneadas int(10) NOT NULL, entrevistascierrerealizadas int(10) NOT NULL, solicitudessucritas int(10) NOT NULL, PRIMARY KEY (idreporte));
