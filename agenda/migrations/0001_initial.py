    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idEstatus', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='agenda.CatEstatuscita')),
                ('idTipoCita', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='agenda.CatTipocita')),
            ],
        ),
    ]
