...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Contacto',
            fields=[
                ('celular', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estadoCivil', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='login.EstadoCivil')),
            ],
        ),
        migrations.CreateModel(
            name='Roles',
        ...
        migrations.AddField(
            ...
            name='idpersona',
            field=models.ManyToManyField(to='login.Persona'),
        ),
        migrations.AddField(
            model_name='direccion',
